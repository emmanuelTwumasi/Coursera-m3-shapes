...
public class Logic
    ...
    public static double rectangleArea(double length, double width){
        ...
        return  area;
        //returns the area of the rectangle to the nearest whole
    }
    ...
    public static double rightTrianglePerimeter(double base, double height){
        ...
        double hypo =  Math.sqrt(Math.pow(base,2)
                + Math.pow(height,2));
        //computes the length of  hypotenuse
        // and store in the variable hypo

        double perimeter = base + height + hypo;
        //computer the length of perimeter
    ...
    public static double boxVolume(double length, double width, double depth){
        ...
        return  vol;
        //returns vol as the volume
    }

    public static double boxSurfaceArea(double length, double width,
                                        double depth){
        double surfArea = 2*(length * width) + 2*(length * depth) + 2*(depth * width);

        return  surfArea;
        //returns surfArea as the surface area
    }
